...
export class DetailsPage1 {
  ...
  wrong(){
   ...
   $("#back").css({display:'block'});
     ...
     document.getElementById("r").innerHTML = '<div class="alert alert-danger" role="alert"><b>Ops ! </b><br><p>Your answer is <i>wrong</i> <br>Unfortunately we will take 15 points from your score<span class="glyphicon glyphicon-remove" aria-hidden="true"></span></p></div>';
  ...
  goback(){
    this.navCtrl.setRoot(Videos,{a:"ok"});
